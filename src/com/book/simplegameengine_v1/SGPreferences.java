...
public class SGPreferences {
	...
	public boolean getBoolean(String key, boolean defaultValue) {
		try {
			...
			Log.d(SGActivity.TAG, 
					"SGPreferences.getBoolean(): Valor possui um tipo diferente!");
			return defaultValue;
		}
	}
	...
	public float getFloat(String key, float defaultValue){
		try{
			...
			Log.d(SGActivity.TAG, 
					"SGPreferences.getFloat(): Valor possui um tipo diferente!");
			return defaultValue;
		}
	}
	...
	public int getInt(String key, int defaultValue){
		try{
			...
			Log.d(SGActivity.TAG, 
					"SGPreferences.getInt(): Valor possui um tipo diferente!");
			return defaultValue;
		}
	}
	...
	public long getLong(String key, long defaultValue){
		try{
			...
			Log.d(SGActivity.TAG, 
					"SGPreferences.getLong(): Valor possui um tipo diferente!");
			return defaultValue;
		}
	}
	...
	public String getString(String key, String defaultValue){
		try{
			...
			Log.d(SGActivity.TAG, 
					"SGPreferences.getString(): Valor possui um tipo diferente!");
			return defaultValue;
		}
	}
